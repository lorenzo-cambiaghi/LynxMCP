...
# Rendering and the playground moved out — `render.py` holds the HTML
# fragments (pure functions over data), `playground.py` the per-tool panels,
# the surface that grows with every new tool. Imported here because this
# module still uses them, and re-exported because callers and tests reach
# for `routes._render_hits` and friends.
from .render import (  # noqa: F401 - several are re-exports
    _empty,
    _err,
    _html_escape,
    _render_hits,
...
from .playground import (  # noqa: F401 - re-exported
    _register_playground_routes,
    _reports_dir,
)
