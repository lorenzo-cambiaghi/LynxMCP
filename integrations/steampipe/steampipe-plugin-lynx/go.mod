module github.com/lorenzo-cambiaghi/steampipe-plugin-lynx

go 1.26.0

// Run `go mod tidy` (with network) to populate the SDK + transitive deps and
// write go.sum. The only direct dependency is:
//   github.com/turbot/steampipe-plugin-sdk/v5
